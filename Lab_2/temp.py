...
for i in range(10):
    ...
    ship["maxNumberOfAllContainers"] = 20
    ship["maxNumberOfHeavyContainers"] = 5
    ship["maxNumberOfRefrigeratedContainers"] = 2
    ship["maxNumberOfLiquidContainers"] = 5
    ship["fuelConsumptionPerKM"] = 20
    ships.append(ship)
